...
//     int16_t brushless_motor_speed_relative_to_max_speed = motor_controller.ReadBrushlessMotorSpeedRelativeToMaxSpeed(2);
//     std::cout << brushless_motor_speed_relative_to_max_speed << std::endl;

//     int16_t battery_amps = motor_controller.ReadBatteryAmps(2);
//     std::cout << battery_amps << std::endl;

//     uint16_t internal_voltages = motor_controller.ReadInternalVoltages(1); // 1 = Internal volts, 2 = Battery volts, 3 = 5V output
...
//     uint32_t time = motor_controller.ReadTime(1); // 1 : Seconds, 2 : Minutes, 3 : Hours (24h format), 4 : Dayofmonth, 5 : Month, 6 : Year in full,
...
//     // // int16_t mag_sensor_track_position = motor_controller.ReadMagsensorTrackPosition(uint8_t nb_pulse); //  3 * Total Number of Pulse Inputs
//     // //  std::cout << mag_sensor_track_position << std::endl;
    
//     // // uint8_t mag_sensor_markers = motor_controller.ReadMagsensorMarkers(uint8_t nb_pulse);  // 2 * Total Number of Pulse Inputs
//     // //  std::cout << mag_sensor_markers << std::endl;

//     // // uint16_t mag_sensor_status = motor_controller.ReadMagsensorStatus(uint8_t nb_pulse);  //  Total Number of Pulse Inputs
//     // //  std::cout << mag_sensor_status << std::endl;

//     // // uint16_t motor_status_flags = motor_controller.ReadMotorStatusFlags(uint8_t nb_pulse); //  Total Number of Pulse Inputs
